...
#Get Tesla tweets
ticker_tweets_TSLA = scrape_tweets_and_sentiments(150000, "TSLA", ticker_tweets)
ticker_set_TSLA = ticker_set_TSLA.append(ticker_tweets_TSLA)

pd.set_option('display.max_columns', None)
print(ticker_set_TSLA)
pd.reset_option('display.max_rows')

ticker_set_TSLA.to_csv(r'/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Trading the twitter sentiment replica/Input/1. Data Daily/ticker_set_TSLA.csv', index = False)
ticker_set_TSLA.to_csv(r'/Users/fabianwinkelmann/Library/Mobile Documents/com~apple~CloudDocs/Master Thesis/Code/Trading the twitter sentiment replica/Input/2. Data Hourly/ticker_set_TSLA.csv', index = False)
